...
```{r}
tibble(x = 1:5,
       y = x ^ 2, ## allows you to back trace, using x as a variable in another variable
       text = c("alpha", "beta", "gamma", "delta", "epsilon"))
...
## direction=-1 colour palette the other way around
...
ggplot(gapminder, aes(x=lifeExp)) +
  geom_histogram(binwidth=5, aes(y=..density.., fill=continent)) +
  ## y=..density.. makes scale by proportion and not count
