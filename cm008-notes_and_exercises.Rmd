...
## Typically don't want to change label on a continuous scale, better for discrete scale
...
## is.na() filters to true and false, and ! means is not NA
```
...
gapminder %>%
  ...
  geom_line(alpha=0.2, aes(group=country, colour=log(max_gdpPercap))) + 
  facet_wrap(~ continent) +
  theme_bw() +
  scale_x_continuous("", breaks=c(1950, 1975, 2000)) +
  scale_y_log10("Population (in millions)",
